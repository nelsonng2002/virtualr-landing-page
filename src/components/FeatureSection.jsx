...
export const FeatureSection = () => {
  return (
    <div className='relative mt-10 border-b border-neutral-800 min-h-[800px]' id='features'>
        <div className="text-center">
            <span className='bg-neutral-900 text-orange-500 rounded-full h-6 text-lg font-medium px-2 py-1 uppercase'> 
                Features
            </span>
            <h2 className='text-3xl sm:text-3xl lg:text-4xl mt-10 lg:mt-20 tracking wide'>
                Easily build 
